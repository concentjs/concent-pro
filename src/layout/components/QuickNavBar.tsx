...
import QuickSettingIcon from './QuickSettingIcon';
    ...
    <div className={`quickNavBarWrapBase ${gcu.navBarItemCls} smallScBar`} style={gcu.quickNavBarStyle}>
      <Tabs
        ...
        {activeRoutePaths.map(({ path, search }) => {
          ...
          let stNavItem = {};
          if (curActiveRouteFullPath !== pathWithSearch) {
            stNavItem = { color: gcu.iconCtrl.color };
          }
          ...
          const uiTab = (
            ...
            >
              <span style={stNavItem}>{uiIcon}{item.label}</span>
            </Tooltip>
          );
      ...
      <div className={styles.headerSettingWrapInBar}>
        ...
        />
        {gcu.iconCtrl.showInBar && <><Blank width="5px" /> <QuickSettingIcon mode="bar" /></>}
